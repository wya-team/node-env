...
const builds = {
	...
	// tpl: {
	// 	script: 'babel packages/tpl/src --out-dir packages/tpl/dist --copy-files --ignore **.test.js,**.md,examples/**',
	// 	rollup: {
	// 		entry: 'packages/tpl/src/index.js',
	// 		dest: 'packages/tpl/dist/tpl.min.js',
	// 		format: 'cjs'
	// 	}
	// }
};
